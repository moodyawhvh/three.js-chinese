/**
 * =============================================================================
 * constants.js —— three.js 全局常量表(中文注释版)
 * -----------------------------------------------------------------------------
 * 本文件集中定义 three.js 使用的所有枚举型常量,涵盖:
 * 鼠标/触摸交互、面剔除、阴影贴图类型、色彩空间、颜色编码、
 * 纹理格式与类型、数据类型、缓冲区用法、混合因子/方程、
 * 裁剪行为、深度/模板测试、材质侧、着色器名等。
 * 数值本身是 WebGL/引擎内部约定的枚举值,请勿自行改动。
 * =============================================================================
 */

/** 引擎修订版本号(与 GitHub 仓库 r1xx 版本对应)。 */
export const REVISION = '186dev';

/**
 * 表示控件(Control)上下文中的鼠标按键与交互类型。
 * LEFT/MIDDLE/RIGHT 为鼠标按键;ROTATE/DOLLY/PAN 为交互动作(旋转/缩放/平移)。
 *
...
/**
 * 表示控件上下文中的触摸交互类型(旋转/平移/双指缩放+平移/双指缩放+旋转)。
 *
 ...
 * @constant
 */
export const FrontSide = 0; // 正面(材质 .side 默认值,只渲染正面)
 ...
 * @constant
 */
export const AddEquation = 100; // 混合方程:相加(默认)
 ...
 * @constant
 */
export const SrcAlphaFactor = 204; // 混合源因子:源 alpha(默认)
 ...
 * @constant
 */
export const UVMapping = 300; // 纹理映射:普通 UV 映射(默认)
 ...
 * @constant
 */
export const RepeatWrapping = 1000; // 纹理包裹:重复平铺
 ...
 * @constant
 */
export const LinearFilter = 1006; // 纹理放大过滤:线性过滤(默认)
 ...
 * @constant
 */
export const UnsignedByteType = 1009; // 数据类型:无符号字节(纹理默认)
 ...
 * @constant
 */
export const RGBAFormat = 1023; // 纹理格式:RGBA 四通道(默认)
 ...
 * @constant
 */
export const InterpolateSmooth = 2302; // 关键帧插值:平滑(立方)插值
 ...
 * @constant
 */
export const SRGBColorSpace = 'srgb'; // 色彩空间:sRGB(输出默认,适合显示)
 ...
 * @constant
 */
export const KeepStencilOp = 7680; // 模板操作:保持模板缓冲值不变(默认)
 ...
 * @constant
 */
export const StaticDrawUsage = 35044; // 缓冲区用法:静态绘制(数据一次上传多次绘制)
